        ...
        if len(jsonData["docs"]["docs"]) >= 1:
            for event_document in jsonData["docs"]["docs"]:
                ...
                event_info = {
                            ...
                            "description": soup.find("div", attrs={"id":"tab-description"}).text.strip(),
